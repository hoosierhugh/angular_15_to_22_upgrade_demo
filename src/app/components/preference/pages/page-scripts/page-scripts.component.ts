...
export class PageScriptsComponent implements OnInit, AfterViewInit {
    private authenticationService = inject(AuthenticationService);
    private alertService = inject(AlertService);
    private service = inject(PreferenceScriptsService);
    ...
    settingDialog(item: PreferenceScripts | null = null, type?: string) {
    ...
    deleteDialog(item: PreferenceScripts | null = null) {
